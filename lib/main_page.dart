import 'dart:convert';
import 'package:colortest/widgets/action_button.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Flutter X Arduino'),
      ),
      body: Column(
        children: [
          _controlBT(),
                      ...
                      ListTile(
                        ...
                        trailing: TextButton(
                          ...
                          onPressed: () async {
                            ...
                            setState(() {});
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ColorPickerScreen(conexion: _connection)));
                          },
                        ),
                      )
                  ]
